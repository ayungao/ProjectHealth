...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "oAKUe6ITRpBWSnVkrSSfhJMRZWOYjOchW24kZm_i";
    private static final String SECRETKEY = "EbdesT3OcqDsNFjSf_5xRqs6A2mHjjN7zatm77bs";
    private static final String BUCKET = "98health";
    public static final String DOMAIN= "http://qt5njnaiw.hd-bkt.clouddn.com/";

    public static void main(String[] args) {
//        uploadFile("C:\\Users\\Lenovo\\Desktop\\Cloud Certification Program & Grant Certification Qualification.JPG","dd1.jpg");
        removeFiles("dd1.jpg");
    }
